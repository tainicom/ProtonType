...
namespace tainicom.ProtonType.ViewModels
{
    public class FolderItem : BrowserItem
    {
            ...
            : base(fileBrowser, relativePath)
        {
            ...
            watcher.Changed += new FileSystemEventHandler(InnerWatcherChanged);
            watcher.Created += new FileSystemEventHandler(InnerWatcherCreated);
            watcher.Deleted += new FileSystemEventHandler(InnerWatcherDeleted);
            watcher.Renamed += new RenamedEventHandler(InnerWatcherRenamed);
        ...
        void InnerWatcherChanged(object sender, FileSystemEventArgs e)
        {
        ...
        void InnerWatcherCreated(object sender, FileSystemEventArgs e)
        {
            Application.Current.Dispatcher.Invoke(DispatcherPriority.Send, new Action(() =>
            {
                OnWatcherCreated(e);
        ...
        void InnerWatcherDeleted(object sender, FileSystemEventArgs e)
        {
            Application.Current.Dispatcher.Invoke(DispatcherPriority.Send, new Action(() =>
            {
                OnWatcherDeleted(e);
        ...
        void InnerWatcherRenamed(object sender, RenamedEventArgs e)
        {
            Application.Current.Dispatcher.Invoke(DispatcherPriority.Send, new Action(() =>
                {
                    OnWatcherRenamed(e);
