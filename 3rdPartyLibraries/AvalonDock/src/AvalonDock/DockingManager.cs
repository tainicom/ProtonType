...
namespace AvalonDock
{
    ...
    public class DockingManager : Control, IOverlayWindowHost//, ILogicalChildrenContainer
    {
        ...
        {
            var documentClosingHandler = DocumentClosing;
            if (documentClosingHandler != null)
            {
                var evargs = new DocumentClosingEventArgs(document);
                documentClosingHandler(this, evargs);
                if (evargs.Cancel)
                    return;
            }
            ...
            var documentClosedHandler = DocumentClosed;
            if (documentClosedHandler != null)
            { 
                var evargs = new DocumentClosedEventArgs(document);
                documentClosedHandler(this, evargs);
            }
        ...
        internal void _ExecuteCloseCommand(LayoutAnchorable anchorable)
        {
            ...
            var anchorableClosingHandler = AnchorableClosing;
            if (anchorableClosingHandler != null)
            {
                var evargs = new AnchorableClosingEventArgs(anchorable);
                anchorableClosingHandler(this, evargs);
                if (evargs.Cancel)
                    return;
            }

            if (!anchorable.TestCanClose())
                return;
            ...
            var anchorableClosedHandler = AnchorableClosed;
            if (anchorableClosedHandler != null)
            {
                var evargs = new AnchorableClosedEventArgs(anchorable);
                anchorableClosedHandler(this, evargs);
            }
        ...
        internal void _ExecuteHideCommand(LayoutAnchorable anchorable)
        {
            ...
            var anchorableHidingHandler = AnchorableHiding;
            if (anchorableHidingHandler != null)
            {
                var evargs = new AnchorableHidingEventArgs(anchorable);
                anchorableHidingHandler(this, evargs);
                if (evargs.Cancel)
                    return;
            }
            ...
            var anchorableHiddenHandler = AnchorableHidden;
            if (anchorableHiddenHandler != null)
            {
                var evargs = new AnchorableHiddenEventArgs(anchorable);
                anchorableHiddenHandler(this, evargs);
            }
